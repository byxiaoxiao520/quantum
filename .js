...
# WPS VIP By eHpo
^https?:\/\/account\.wps\.cn\/api\/users\/ url script-response-body https://raw.githubusercontent.com/an0na/R/master/Script/wps.js

# VUE Vlog Pro by NoByDa
;^https?:\/\/api\.vuevideo\.net\/api\/v1\/(users\/.+\/profile|subtitle\/prepare) url script-response-body https://raw.githubusercontent.com/an0na/R/master/Script/VUE.js
...
# > 买单吧
;^https?:\/\/creditcardapp\.bankcomm\.com\/mappweb_interaction\/common\/getPopAds\.do$ url reject-200
;^https?:\/\/creditcardapp\.bankcomm\.com\/mappweb_interaction\/common\/queryGuidePageAds\.do url reject-200
...
# A
# > 阿里巴巴
^https?:\/\/(gw|heic)\.alicdn\.com\/.*\.jpg_(9\d{2}|\d{4}) url reject-200
# >> 闲鱼
...
# ^https?:\/\/(api|atrace)\.chelaile\.net\.cn\/adpub\/ url reject-200
...
# > 墨迹天气
^https?:\/\/cdn\.moji\.com\/(adoss|adlink)\/ url reject-200
# > 埋堆堆
...
# > 美味不用等
^https?:\/\/capi.mwee.cn/app-api/V\d{2}/app/(ad|getstartad) url reject-200
# > 秒拍
...
# > 人人影视
^https?:\/\/ctrl\.(playcvn|zmzapi)\.(com|net)\/app\/(ads|init) url reject-200
# > 日日煮
...
# >> 新浪天气通
^https?:\/\/tqt\.weibo\.cn\/overall\/redirect\.php\?r=tqt_sdkad url reject-200
^https?:\/\/tqt\.weibo\.cn\/overall\/redirect\.php\?r=tqtad url reject-200
...
# > 育学园
^https?:\/\/yxyapi\d\.drcuiyutao\.com\/yxy-api-gateway\/api\/json\/advert\/ url reject-dict
# > 迅雷
